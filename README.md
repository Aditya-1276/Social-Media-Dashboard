...
Deliverables include a Google Sheets dashboard for high-level monitoring and a Power BI dashboard for deeper analytical exploration, covering engagement performance, posting patterns, hashtag strategy, and game-level content analysis.
